...
class ProductPage(BasePage):
    ...
    def should_be_massage_product_added_to_basket(self):
        ...
        product_name_in_message_add = self.browser.find_element(*ProductPageLocators.PRODUCT_NAME_IN_MESSAGE_SUCCESS_ADDED_TO_BASKET).text
    ...
    def should_be_message_price_basket(self):
        ...
        product_price_in_message_price = self.browser.find_element(*ProductPageLocators.PRODUCT_PRICE_IN_MESSAGE_PRICE_BASKET).text
